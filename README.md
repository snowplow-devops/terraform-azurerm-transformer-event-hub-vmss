...
| <a name="input_app_version"></a> [app\_version](#input\_app\_version) | Transformer app version to use. This variable facilitates dev flow, the modules may not work with anything other than the default value. | `string` | `"5.7.0"` | no |
